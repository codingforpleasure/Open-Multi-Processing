...
int main(int argc, const char *argv[])
{
	...
	{
		/* each thread holds it's stack, the stack holds the variables below. 
		   The reason for this for avoiding race control.*/
	...
	/* Back to the master thread, now our single thread should sum up all the partial sums
